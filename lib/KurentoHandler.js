...
class SendHandler extends Handler
{
	...
	async removeProducer(producer)
	{
		...
		try
		{
			...
			logger.debug(
				'removeProducer() | calling endpoint.processAnswer() [answer:%o]',
				answer);
...
class RecvHandler extends Handler
{
	...
	async addConsumer(consumer)
	{
		...
		try
		{
			...
			const remoteSdp = 
				this._remoteSdp.createOfferSdp(Array.from(this._consumerInfos.values()));
